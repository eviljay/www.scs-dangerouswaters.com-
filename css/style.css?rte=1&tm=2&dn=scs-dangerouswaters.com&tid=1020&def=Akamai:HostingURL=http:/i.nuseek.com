...
.searchBox {display:inline-block;               
    ...
    .sb_button {width:70px;
				height:22px;														  		   
				background:transparent url(http://rte-las.nuseek.com/templates/t1020/images/btn-blacklime.png) no-repeat;
			    border:0;
			    cursor:pointer;}
...
.rs li a {display:block;
          background:transparent url(http://rte-las.nuseek.com/templates/t1020/images/blt-greenarrow.png) no-repeat 0 5px;
...
.results li {margin:0 0 15px;
             padding-left:28px;
		     background:transparent url(http://rte-las.nuseek.com/templates/t1020/images/blt-greenarrow.png) no-repeat 0 2px;}
